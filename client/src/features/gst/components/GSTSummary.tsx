                ...
                <Card className="neu-inset rounded-xl">
                    <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold text-blue-400">
                            {formatCurrency(data.gstCredits)}
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card className="neu-inset rounded-xl border-[#FFCC00]/20">
                    <CardContent className="p-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {netChange !== null && (
                                <span className={`flex items-center text-xs ${netChange > 0 ? 'text-red-400' : 'text-emerald-400'}`}>
                                    {netChange > 0 ? <TrendingUp className="w-3 h-3 mr-0.5" /> : <TrendingDown className="w-3 h-3 mr-0.5" />}
                ...
                <CardContent>
                    <div className="space-y-3 text-sm">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-medium">{formatCurrency(data.breakdown.taxable.purchases)}</span>
                        </div>
                        <div className="flex justify-between items-center">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-medium">{formatCurrency(data.breakdown.gstFree.purchases)}</span>
                        </div>
                        <div className="flex justify-between items-center">
                    ...
                    <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between text-xs text-zinc-500">
                        <span>{data.transactionsClassified} classified | {data.transactionsNeedReview} need review</span>
                    </div>
                </CardContent>
            </Card>
