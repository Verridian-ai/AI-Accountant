...
export function InputTaxCredits({ period = 'current', businessOnly: _businessOnly }: InputTaxCreditsProps) {
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-zinc-500">
                        Total Claimable: <span className="text-emerald-400 font-medium">{formatCurrency(totalClaimable)}</span>
                    </p>
                </div>
                ...
                <Card className="rounded-xl border-amber-500/20 bg-amber-500/5">
                    <CardContent className="p-3 flex items-start gap-2">
                        ...
                        <p className="text-xs text-amber-400">
                            GST credits over $82.50 without a valid tax invoice may be disallowed.
                            Ensure you have invoices for all claimable credits.
                        </p>
                    </CardContent>
                </Card>
            )}
