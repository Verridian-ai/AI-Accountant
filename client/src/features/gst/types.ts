export type GSTCategory = 'taxable_10' | 'gst_free' | 'input_taxed' | 'export' | 'capital' | 'private' | 'no_abn';
...
export interface BASCalculationEnhanced {
    ...
    labels: {
        ...
        G6?: number; G7?: number; G8?: number; G9?: number;
        G10?: number; G11?: number; G12?: number;
        '1A': number; '1B': number;
        W1?: number; W2?: number; '5A'?: number;
        '7C'?: number; '7D'?: number;
    };
    netGST: number;
    totalPayable: number;
