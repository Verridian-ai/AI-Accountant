...
export const FINANCIAL_GOALS = [
    { id: 'tax_optimization', label: 'Optimize Tax Deductions', icon: 'receipt', description: 'Maximize legitimate deductions' },
    { id: 'bas_compliance', label: 'BAS Compliance', icon: 'calculator', description: 'Stay on top of GST obligations' },
    { id: 'expense_tracking', label: 'Track Expenses', icon: 'trending-down', description: 'Understand where money goes' },
    { id: 'income_growth', label: 'Grow Income', icon: 'trending-up', description: 'Monitor revenue trends' },
    { id: 'cash_flow', label: 'Manage Cash Flow', icon: 'wallet', description: 'Ensure liquidity' },
    { id: 'debt_reduction', label: 'Reduce Debt', icon: 'minus-circle', description: 'Pay down liabilities faster' },
    { id: 'savings_goals', label: 'Build Savings', icon: 'piggy-bank', description: 'Accumulate reserves' },
    { id: 'investment_tracking', label: 'Track Investments', icon: 'bar-chart', description: 'Monitor portfolio performance' },
] as const;
