        ...
        {revenue && (
          <Card className="neu-raised border-border/50">
            ...
            <CardContent>
              ...
              <Badge
                variant="outline"
                className={`mt-2 ${revenue.growthRate >= 0 ? 'text-emerald-400 border-emerald-500/20' : 'text-red-400 border-red-500/20'}`}
              >
                {revenue.growthRate >= 0 ? '+' : ''}
                {formatPercent(revenue.growthRate)} monthly
              </Badge>
            </CardContent>
          </Card>
        )}
        {expenses && (
          <Card className="neu-raised border-border/50">
            ...
            <CardContent>
              ...
              <Badge
                variant="outline"
                className={`mt-2 ${expenses.growthRate >= 0 ? 'text-red-400 border-red-500/20' : 'text-emerald-400 border-emerald-500/20'}`}
              >
                {expenses.growthRate >= 0 ? '+' : ''}
                {formatPercent(expenses.growthRate)} monthly
              </Badge>
            </CardContent>
          </Card>
        )}
      ...
      {revenue && revenue.projections.length > 0 && (
        <Card className="neu-raised border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              {revenue.monthsProjected}-month forecast with confidence bands
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {expenses && expenses.projections.length > 0 && (
        <Card className="neu-raised border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              {expenses.monthsProjected}-month forecast with confidence bands
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
