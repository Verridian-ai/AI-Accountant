      ...
      >
        ...
        <div className="px-5 pb-5 grid grid-cols-3 gap-3">
          <div className="text-center neu-inset rounded-2xl p-3 border border-border/50">
            ...
            <p className="text-[8px] text-zinc-600 uppercase tracking-[0.2em] font-black mt-1">
              Months
            </p>
          </div>
          <div className="text-center neu-inset rounded-2xl p-3 border border-border/50">
  ...
  return (
    <div className="neu-raised rounded-[2.5rem] p-6 border border-border/50 flex flex-col group">
      ...
      <div className="space-y-6">
        ...
        {!loading &&
          recommendations &&
          (recommendations.aggressive || recommendations.moderate || recommendations.minimum) && (
            <div className="space-y-4 animate-in fade-in duration-500">
              {renderStrategy(
