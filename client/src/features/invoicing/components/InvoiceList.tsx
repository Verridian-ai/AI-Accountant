            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-800">
                  ...
                  <th className="text-left px-4 py-3 text-[10px] uppercase tracking-wider text-zinc-500 font-semibold hidden md:table-cell">
                    Issue Date
                  </th>
                  <th className="text-left px-4 py-3 text-[10px] uppercase tracking-wider text-zinc-500 font-semibold hidden md:table-cell">
                    Due Date
                  ...
                  <th className="text-center px-4 py-3 text-[10px] uppercase tracking-wider text-zinc-500 font-semibold">
                    Status
                  </th>
                  <th className="text-right px-4 py-3 text-[10px] uppercase tracking-wider text-zinc-500 font-semibold">
                    Actions
                ...
                {invoices.map((inv) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className={cn(
                          'px-4 py-3 text-zinc-400 hidden md:table-cell',
                          sc.strikethrough && 'line-through',
                        )}
                      >
