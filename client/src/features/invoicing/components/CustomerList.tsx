            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-800">
                  ...
                  <th className="text-left px-4 py-3 text-[10px] uppercase tracking-wider text-zinc-500 font-semibold hidden lg:table-cell">
                    Email
                  </th>
                  <th className="text-left px-4 py-3 text-[10px] uppercase tracking-wider text-zinc-500 font-semibold hidden xl:table-cell">
                    ABN
                  </th>
              ...
              <tbody>
                {customers.map((c: any) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-zinc-500 font-mono text-xs hidden xl:table-cell">
                      {formatABN(c.abn)}
                    </td>
