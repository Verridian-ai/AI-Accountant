...
import { FileText, Users, PlusCircle, DollarSign, AlertTriangle, TrendingUp, Loader2, ArrowLeft, Eye } from 'lucide-react';
...
export function InvoicingDashboard() {
    ...
    const loadStats = async () => {
        ...
        try {
            const customersRes = await invoicingApi.listCustomers({ limit: 1000 }).catch(() => ({ customers: [], total: 0 }));
    ...
    const renderCustomerContent = () => {
        ...
        return (
            <CustomerList
                ...
                onAddCustomer={() => { setEditingCustomer(null); setShowCustomerForm(true); }}
            />
        );
    };
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="neu-raised rounded-2xl p-4 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-zinc-600 uppercase font-semibold tracking-wider">Outstanding</p>
                        {statsLoading ? (
                ...
                <div className="neu-raised rounded-2xl p-4 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-zinc-600 uppercase font-semibold tracking-wider">Overdue</p>
                        {statsLoading ? (
                            <Loader2 className="w-4 h-4 animate-spin text-zinc-500 mt-1" />
                        ) : (
                            <p className={cn(
                ...
                <div className="neu-raised rounded-2xl p-4 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-zinc-600 uppercase font-semibold tracking-wider">Revenue (Month)</p>
                        {statsLoading ? (
                            <Loader2 className="w-4 h-4 animate-spin text-zinc-500 mt-1" />
                        ) : (
                ...
                <div className="neu-raised rounded-2xl p-4 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-zinc-600 uppercase font-semibold tracking-wider">Customers</p>
                        {statsLoading ? (
                            <Loader2 className="w-4 h-4 animate-spin text-zinc-500 mt-1" />
                        ) : (
