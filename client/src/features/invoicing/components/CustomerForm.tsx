        ...
        <div className="neu-raised rounded-2xl p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">Contact Name</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">Email</label>
                        <input
                            type="email"
                            value={form.email}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">Phone</label>
                        <input
                            type="text"
                            value={form.phone}
                    ...
                    <div>
                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">ABN</label>
                        <input
                            type="text"
                            value={form.abn}
                ...
                {/* Address */}
                <div>
                    <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">Address</label>
                    <input
                        type="text"
                        value={form.address}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div>
                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">City</label>
                        <input
                            type="text"
                            value={form.city}
                    ...
                    <div>
                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">State</label>
                        <select
                            value={form.state}
                            onChange={e => setField('state', e.target.value)}
                            className={cn(inputClass(), "cursor-pointer")}
                        >
                            <option value="" className="bg-[#1a1b26]">Select...</option>
                            {AU_STATES.map(s => (
                                <option key={s} value={s} className="bg-[#1a1b26]">{s}</option>
                            ))}
                        </select>
                    </div>
                    <div>
                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">Postcode</label>
                        <input
                            type="text"
                            value={form.postcode}
                    ...
                    <div>
                        <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">Country</label>
                        <input
                            type="text"
                            value={form.country}
                ...
                <div className="sm:w-1/4">
                    <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">Payment Terms (days)</label>
                    <input
                        type="number"
                ...
                {/* Notes */}
                <div>
                    <label className="block text-[10px] text-zinc-500 uppercase tracking-wider font-semibold mb-1">Notes</label>
                    <textarea
                        value={form.notes}
