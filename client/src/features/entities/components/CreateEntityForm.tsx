...
const ENTITY_TYPES: Array<{ value: EntityData['entityType']; label: string; description: string }> = [
    { value: 'sole_trader', label: 'Sole Trader', description: 'Individual trading — income taxed at personal rates' },
    { value: 'company', label: 'Company', description: '25-30% flat tax rate, separate legal entity' },
    { value: 'trust', label: 'Trust', description: 'Distributes income to beneficiaries, flexible tax planning' },
    { value: 'partnership', label: 'Partnership', description: 'Income split between partners' },
    { value: 'smsf', label: 'SMSF', description: 'Self-managed super fund — 15% concessional tax rate' },
            ...
            <CardContent className="px-0 pb-0">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select value={entityType} onValueChange={(v: EntityData['entityType']) => setEntityType(v)}>
                            <SelectTrigger>
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div className="space-y-1.5">
                        ...
                        />
                        {abn && !abnValid && (
                            <p className="text-xs text-red-400">ABN must be 11 digits</p>
                        )}
                    </div>
