...
export function EntitiesDashboard() {
    ...
    const linkedAccounts = entities.reduce((sum, e) => sum + e.accounts.length, 0);
    const consolidatedParents = entities.filter(e => e.isConsolidatedParent).length;
