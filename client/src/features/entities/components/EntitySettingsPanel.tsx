...
export function EntitySettingsPanel({ entities }: EntitySettingsPanelProps) {
    ...
    const debouncedSave = useCallback((updated: EntitySettingData) => {
    ...
    const updateSetting = <K extends keyof EntitySettingData>(key: K, value: EntitySettingData[K]) => {
        if (!settings) return;
            ...
            {!settings ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <Card className="neu-raised border-0">
                        <CardContent className="p-4 space-y-3">
                            <div>
                                <Label className="text-sm font-bold text-zinc-200">Default Depreciation Method</Label>
                                <p className="text-xs text-zinc-500 mt-0.5">
                    ...
                    <Card className="neu-raised border-0">
                        <CardContent className="p-4 space-y-3">
                            <div>
                                <Label className="text-sm font-bold text-zinc-200">Instant Write-Off Threshold ($)</Label>
                                <p className="text-xs text-zinc-500 mt-0.5">
                            ...
                            <Input
                                ...
                                onChange={e => updateSetting('instantWriteOffThreshold', Math.round((parseFloat(e.target.value) || 0) * 100))}
                            />
                        </CardContent>
                    </Card>
                </div>
