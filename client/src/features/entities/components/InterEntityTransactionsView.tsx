...
const TRANSACTION_TYPES = [
    'loan', 'management_fee', 'dividend', 'distribution',
    'rent', 'service_fee', 'asset_transfer', 'capital_contribution',
];
...
export function InterEntityTransactionsView({ entities, selectedEntityId }: InterEntityTransactionsViewProps) {
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 items-center">
                                    ...
                                    <div className="col-span-1">
                                        ...
                                        {tx.transactionType === 'loan' && (
                                            <Badge variant="outline" className="ml-1 bg-red-500/10 text-red-400 border-red-500/30 text-[10px]">
                                    ...
                                    <div className="col-span-2 flex items-center justify-end gap-1">
                                        {tx.status === 'pending' && (
                                            <>
                                                ...
                                                >
                                                    {confirming === tx.id ? <Loader2 className="w-3 h-3 animate-spin" /> : <Check className="w-3 h-3" />}
                                                </Button>
                                                <Button
                                                    size="sm"
                                                    variant="outline"
