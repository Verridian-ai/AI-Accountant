  ...
  if (loading) {
    return (
      <div className="neu-raised rounded-2xl p-6 space-y-4">
        ...
        <div className="h-4 w-32 bg-overlay rounded animate-pulse" />
        <div className="space-y-3 mt-4">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="h-10 bg-overlay rounded-xl animate-pulse" />
          ))}
        </div>
      </div>
    );
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        {[
          ...
          <div key={card.label} className="neu-raised rounded-xl p-3">
            ...
            <p
              className={`text-lg font-bold mt-0.5 font-mono ${card.accent ? 'text-cba-gold' : 'text-primary'}`}
            >
              $
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm transition-all ${
            showHistory
              ...
              : 'bg-overlay border border-border text-primary hover:bg-overlay-hover'
          }`}
        >
      ...
      {showForm && (
        <div className="neu-raised rounded-2xl p-5 space-y-4">
          <div className="flex items-center justify-between">
            <h4 className="text-sm font-semibold text-primary">New Pay Item</h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-xl bg-overlay border border-border text-sm text-primary focus:outline-none focus:ring-1 focus:ring-[#FFCC00]/40"
              />
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-cba-gold text-black font-semibold text-sm hover:bg-cba-gold/90 transition-all disabled:opacity-40 disabled:pointer-events-none"
            >
      ...
      {displayItems.length === 0 ? (
        <div className="neu-raised rounded-2xl p-8 text-center">
          ...
          <p className="text-secondary font-medium">No pay items configured</p>
        ...
        <div className="neu-raised rounded-2xl overflow-hidden">
          <table className="w-full">
            <thead>
              <tr className="border-b border-border/50">
                ...
                <th className="text-right text-xs font-medium text-muted uppercase tracking-wider px-4 py-3 hidden md:table-cell">
                  Hrs/Wk
                </th>
                ...
                {showHistory && (
                  <th className="text-center text-xs font-medium text-muted uppercase tracking-wider px-4 py-3">
                    Active
                  </th>
                )}
              </tr>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 hidden sm:table-cell">
                      <span className="text-xs text-secondary capitalize">{item.rateType}</span>
                    </td>
          ...
          <div className="border-t border-border px-4 py-3 flex items-center justify-between bg-cba-gold/[0.03]">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-cba-gold/10 text-cba-gold">
                super
              </span>
            ...
            <div className="text-right">
              <span className="text-sm text-cba-gold font-mono font-semibold">
                $
