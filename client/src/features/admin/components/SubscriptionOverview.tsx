...
const mockPlans: SubscriptionPlan[] = [
    ...
    { id: 'business', name: 'Business', price: 4999, userCount: 189, revenue: 944811, color: '#22c55e' },
    { id: 'enterprise', name: 'Enterprise', price: 9999, userCount: 45, revenue: 449955, color: '#3b82f6' },
];
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-zinc-500">
                                    {formatCurrency(totalRevenue)} this period
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="flex items-end justify-between h-full gap-4 px-2">
                        {churnData.map((data) => {
                            const maxValue = Math.max(
                                ...churnData.map((d) => Math.max(d.churned, d.gained))
                            );
                            return (
                                <div
                                    key={data.month}
        ...
        <div className={cn('space-y-6', className)}>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[...Array(4)].map((_, i) => (
                    <div
                        key={i}
                        className="neu-raised rounded-[2rem] p-6 border border-white/5"
                    >
