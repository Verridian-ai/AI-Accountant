        ...
        <div className="space-y-6">
            <Card className="neu-raised border-white/5">
                <CardHeader>
                    ...
                    <CardDescription>Compare Personal Loan vs Chattel Mortgage vs Novated Lease</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                        <div className="space-y-2">
                            ...
                            <Input type="number" step="0.1" value={personalRate} onChange={e => setPersonalRate(e.target.value)} />
                        </div>
                        <div className="space-y-2">
                            <Label>Chattel Mortgage Rate (%)</Label>
                            <Input type="number" step="0.1" value={chattelRate} onChange={e => setChattelRate(e.target.value)} />
                        </div>
                        <div className="space-y-2">
                            <Label>Novated Lease Rate (%)</Label>
                            <Input type="number" step="0.1" value={novatedRate} onChange={e => setNovatedRate(e.target.value)} />
                        </div>
                    </div>
                    <div className="grid gap-4 md:grid-cols-3">
                        <div className="space-y-2">
            ...
            {result && (
                <div className="grid gap-4 md:grid-cols-3">
                    {options.map(opt => {
                        ...
                        return (
                            <Card key={opt.type} className={`neu-raised border-white/5 ${isCheapest ? 'ring-2 ring-[#FFCC00]/50' : ''}`}>
