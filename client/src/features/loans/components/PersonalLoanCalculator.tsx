    ...
    const handleCalculate = async () => {
        ...
        try {
            const data = await loanApi.calculatePersonalLoan({
                ...
                establishmentFee: establishmentFee ? Math.round(parseFloat(establishmentFee) * 100) : undefined,
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <Input type="number" value={establishmentFee} onChange={e => setEstablishmentFee(e.target.value)} />
                        </div>
                        <div className="space-y-2">
            ...
            {result && (
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card className="neu-raised border-white/5">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-amber-400">{formatPercent(result.comparisonRate)}</div>
