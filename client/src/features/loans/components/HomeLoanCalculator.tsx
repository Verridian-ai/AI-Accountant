                ...
                <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input type="number" step="0.01" value={rate} onChange={e => setRate(e.target.value)} placeholder="6.25" />
                        </div>
                        <div className="space-y-2">
                            <Label>Term (years)</Label>
                            <Input type="number" value={term} onChange={e => setTerm(e.target.value)} placeholder="30" />
                        </div>
                    </div>
                    <div className="grid gap-4 md:grid-cols-3">
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input type="number" value={offsetBalance} onChange={e => setOffsetBalance(e.target.value)} placeholder="0" />
                        </div>
                        <div className="space-y-2">
                            <Label>Extra Repayment ($/{frequency})</Label>
                            <Input type="number" value={extraRepayment} onChange={e => setExtraRepayment(e.target.value)} placeholder="0" />
                        </div>
                    </div>
                ...
                <>
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <Card className="neu-raised border-white/5">
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold text-red-400">{formatCurrency(result.totalInterest)}</div>
                            </CardContent>
                        </Card>
                        <Card className="neu-raised border-white/5">
                            <CardHeader className="pb-2">
                                        ...
                                        <tbody>
                                            {result.schedule.slice(0, 12).map(row => (
                                                <tr key={row.period} className="border-b border-white/5 last:border-0">
                                                    ...
                                                    <td className="text-right py-2 px-2 text-emerald-400">{formatCurrency(row.principal)}</td>
