...
import { FileText, BarChart3, Wallet, ArrowUpDown, GitCompareArrows, TrendingUp } from 'lucide-react';
import { api } from '@/api';
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-zinc-500 mt-1">Comprehensive financial statements and KPI tracking</p>
                </div>
            </div>
            ...
            <div className="neu-raised rounded-2xl p-4">
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div>
                        <label className="block text-[10px] text-zinc-500 font-bold uppercase tracking-wider mb-1">Financial Year</label>
                        <select
                            value={selectedFY}
                    ...
                    {/* Custom Date Range */}
                    <div>
                        <label className="block text-[10px] text-zinc-500 font-bold uppercase tracking-wider mb-1">Period Start</label>
                        <input
                            type="date"
                            value={customStart}
                    ...
                    <div>
                        <label className="block text-[10px] text-zinc-500 font-bold uppercase tracking-wider mb-1">Period End</label>
                        <input
                            type="date"
                            value={customEnd}
                    ...
                    {/* Account Filter */}
                    <div>
                        <label className="block text-[10px] text-zinc-500 font-bold uppercase tracking-wider mb-1">Account</label>
                        <select
            ...
            <div className="animate-in fade-in duration-300">
                ...
                {activeTab === 'balance-sheet' && (
                    <BalanceSheet asAtDate={asAtDate} />
                )}
                {activeTab === 'cash-flow' && (
                    <CashFlow periodStart={customStart} periodEnd={customEnd} />
                )}
                {activeTab === 'trial-balance' && (
                    <TrialBalance asAtDate={asAtDate} />
                )}
