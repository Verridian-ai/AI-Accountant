            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>Configure automatic bank reconciliation matching rules</CardDescription>
                    </div>
                    <Button
                        size="sm"
                                ...
                                >
                                        ...
                                        <div className="flex items-center gap-3 flex-1 min-w-0">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    <Badge
                                                        variant="outline"
                                                        className={cn("text-[10px] px-1.5 py-0", matchTypeBadgeColor[rule.matchType] ?? '')}
                                                    >
                                    ...
                                    {expandedRule === rule.id && (
                                        <div className="mt-3 pt-3 border-t border-white/5">
                                            <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-2">Configuration</p>
