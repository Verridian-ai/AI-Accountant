    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <Button onClick={handleGenerate} disabled={generating} className="bg-[#FFCC00] text-[#0a0a0f] hover:bg-[#e6b800]">
            ...
            {suggested.length > 0 && (
                <div className="space-y-4">
                    ...
                    {suggested.map(s => (
                        <Card key={s.id} className="neu-raised border-[#FFCC00]/10 hover:border-[#FFCC00]/30 transition-colors">
                            ...
                            <CardContent className="pt-6 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-zinc-500">Saving: {formatCurrency(s.estimatedSaving)}</p>
                                    </div>
                                </div>
                        ...
                        {dismissed.map(s => (
                            <Card key={s.id} className="neu-raised opacity-50">
                                <CardContent className="pt-4 pb-4 flex items-center justify-between">
                                    ...
                                    <Button size="sm" variant="ghost" onClick={() => handleUpdateStatus(s.id, 'suggested')}>
                                        Restore
                                    </Button>
                                </CardContent>
                            </Card>
