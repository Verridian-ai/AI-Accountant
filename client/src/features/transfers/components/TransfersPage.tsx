...
import {
    GitCompareArrows, GitBranch, Calculator, Zap,
    Loader2, Wallet, CreditCard, CheckCircle2
} from 'lucide-react';
...
export function TransfersPage() {
    ...
    const handleDetect = async () => {
        ...
        try {
            ...
            setNotification(`Detected ${data.matchCount} new transfer match${data.matchCount !== 1 ? 'es' : ''}`);
            await fetchSummary();
        } catch {
    ...
    return (
        <div className="space-y-6">
            {/* Title */}
            <div>
                <h2 className="text-2xl font-bold tracking-tight text-gradient-gold">Cross-Account Intelligence</h2>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3 sm:ml-auto">
                        <div className="neu-inset rounded-xl px-3 py-2 flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-black text-zinc-500 uppercase tracking-wider">Matched</span>
                        ...
                        <div className="neu-inset rounded-xl px-3 py-2 flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-black text-zinc-500 uppercase tracking-wider">Owner</span>
                            <span className="text-xs font-black text-zinc-200">
                        ...
                        <div className="neu-inset rounded-xl px-3 py-2 flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-black text-zinc-500 uppercase tracking-wider">CC Payments</span>
                            <span className="text-xs font-black text-zinc-200">
