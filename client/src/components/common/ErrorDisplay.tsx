    ...
    return (
        <div className={cn(
            ...
            <div className="p-5 rounded-2xl neu-inset border border-red-500/10 space-y-4 bg-red-500/2">
                ...
                <div className="pt-4 border-t border-white/5 text-left">
                    <ErrorRecovery
                        ...
                        onRetry={handleRetry}
                        onManualFix={onManualFix ? () => onManualFix({ stopPropagation: () => { } } as React.MouseEvent) : undefined}
                        onContactSupport={onContactSupport ? () => onContactSupport({ stopPropagation: () => { } } as React.MouseEvent) : undefined}
            ...
            <div className="flex items-center justify-between px-2">
                <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); /* Logic for archive access if needed */ }}
