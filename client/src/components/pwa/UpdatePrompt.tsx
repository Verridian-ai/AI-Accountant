  ...
  return (
    <div className="fixed bottom-20 left-0 right-0 z-50 md:bottom-6 animate-in slide-in-from-bottom-2 duration-300">
      <div className="mx-auto max-w-md px-4">
        <div className="flex items-center gap-3 rounded-xl neu-raised border border-cba-gold/20 px-4 py-3 shadow-lg">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-cba-gold/10">
            <RefreshCw className="h-5 w-5 text-cba-gold" />
          </div>

          <p className="flex-1 text-sm font-medium text-primary">A new version is available</p>
