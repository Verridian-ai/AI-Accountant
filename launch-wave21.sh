#!/bin/bash
# ============================================================
# GoldLedger — Wave 21: Vercel AI SDK Migration & Streaming
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave21.sh
# ============================================================
...
echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 21 Agent Team Launcher${NC}"
echo -e "${CYAN}  Vercel AI SDK Migration & Streaming${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 21: Vercel AI SDK & Streaming "
