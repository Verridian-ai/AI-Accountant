#!/bin/bash
# ============================================================
# GoldLedger — Wave 7: Customer Management & Invoice Generation
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave7.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave7"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 7 Agent Team Launcher${NC}"
echo -e "${CYAN}  Customer Management & Invoice Generation${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 3 completion (Wave 7 depends on Wave 3, NOT Wave 6)
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 7: Customers & Invoicing "
