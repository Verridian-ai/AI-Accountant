#!/bin/bash
# ============================================================
# GoldLedger — Wave 19: Market Intelligence & Sentiment
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave19.sh
# ============================================================
...
echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 19 Agent Team Launcher${NC}"
echo -e "${CYAN}  Market Intelligence & Sentiment${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 18 completion
echo -e "${YELLOW}[3/5] Checking Wave 18 prerequisites...${NC}"
if [ -f "$PROJECT_DIR/.agent-done-wave18" ]; then
    echo -e "${GREEN}  ✓ Wave 18 completed${NC}"
else
    echo -e "${YELLOW}  ⚠ Wave 18 marker not found — proceeding anyway${NC}"
fi
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 19: Market Intel & Sentiment "
