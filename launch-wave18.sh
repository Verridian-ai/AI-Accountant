#!/bin/bash
# ============================================================
# GoldLedger — Wave 18: CDR Open Banking & Loan Comparison
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave18.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave18"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 18 Agent Team Launcher${NC}"
echo -e "${CYAN}  CDR Open Banking & Loan Comparison${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 13 completion
echo -e "${YELLOW}[3/5] Checking Wave 13 prerequisites...${NC}"
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 18: CDR Open Banking & Loans "
