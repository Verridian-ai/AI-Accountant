#!/bin/bash
# ============================================================
# GoldLedger — Wave 13: Financial Reporting & Budgeting
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave13.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave13"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 13 Agent Team Launcher${NC}"
echo -e "${CYAN}  Financial Reporting & Budgeting${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 12 completion
echo -e "${YELLOW}[3/5] Checking Wave 12 prerequisites...${NC}"
if [ -f "$PROJECT_DIR/.agent-done-wave12" ]; then
    echo -e "${GREEN}  ✓ Wave 12 completed${NC}"
else
    echo -e "${YELLOW}  ⚠ Wave 12 marker not found — proceeding anyway${NC}"
fi
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 13: Financial Reporting & Budgeting "
