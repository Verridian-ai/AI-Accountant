# ============================================================
# CBA Statements Parse - Agent Team Quick Launcher (Windows)
# Runs the agent team setup through WSL
# ============================================================

Write-Host ""
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "  CBA Statements Parse - Agent Team Launcher" -ForegroundColor Cyan
Write-Host "  Verridian AI" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""

$ProjectDir = "C:\Users\Danie\Desktop\CBA Statements Parse\cba-statements"
$WslProjectDir = "/mnt/c/Users/Danie/Desktop/CBA Statements Parse/cba-statements"
