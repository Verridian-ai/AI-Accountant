...
<Warning>
  **Dataset scoping** requires specific configuration. See [permissions system](../multi-user-mode/permissions-system/datasets#dataset-isolation) for details on access control requirements and supported database setups.
</Warning>
