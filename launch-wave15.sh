#!/bin/bash
# ============================================================
# GoldLedger — Wave 15: Predictive Analytics & Compliance
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave15.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave15"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 15 Agent Team Launcher${NC}"
echo -e "${CYAN}  Predictive Analytics & Compliance${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 13 + Wave 14 completion
echo -e "${YELLOW}[3/5] Checking Wave 13 + Wave 14 prerequisites...${NC}"
...
if [ -f "$PROJECT_DIR/.agent-done-wave14" ]; then
    echo -e "${GREEN}  ✓ Wave 14 completed${NC}"
else
    echo -e "${YELLOW}  ⚠ Wave 14 marker not found — proceeding anyway${NC}"
fi
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 15: Predictive Analytics & Compliance "
