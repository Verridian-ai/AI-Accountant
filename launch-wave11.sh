#!/bin/bash
# ============================================================
# GoldLedger — Wave 11: Inventory & Bank Reconciliation
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave11.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave11"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 11 Agent Team Launcher${NC}"
echo -e "${CYAN}  Inventory & Bank Reconciliation${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 10 completion
echo -e "${YELLOW}[3/5] Checking Wave 10 prerequisites...${NC}"
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 11: Inventory & Recon "
