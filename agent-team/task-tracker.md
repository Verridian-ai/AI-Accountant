...
|--------|------|-------|--------|------|-------|--------|
| `[R]` | REFACTOR-001 | Archive Deprecated Files | 2h | Low | Gemini | needs branch verification |
| `[ ]` | REFACTOR-028 | Consolidate PDF Libraries | 3h | Low | | |
| `[ ]` | REFACTOR-029 | Move @types to devDependencies | 15m | VLow | | |
...
|--------|------|-------|------|--------|------|-------|--------|
| `[R]` | REFACTOR-002 | Configure ESLint + Prettier | 001 | 4h | Low | Gemini | needs branch verification |
...
| `[ ]` | REFACTOR-024 | Split Large Services Batch 1 | 019 | 8h | Med | | |
