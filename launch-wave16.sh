#!/bin/bash
# ============================================================
# GoldLedger — Wave 16: Custom DataPoints & Graph Relationships
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave16.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave16"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 16 Agent Team Launcher${NC}"
echo -e "${CYAN}  Custom DataPoints & Graph Relationships${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 16: Custom DataPoints & Graph "
