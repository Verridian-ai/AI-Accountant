#!/bin/bash
# ============================================================
# GoldLedger — Wave 9: AR Aging & Multi-Currency
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave9.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave9"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 9 Agent Team Launcher${NC}"
echo -e "${CYAN}  AR Aging & Multi-Currency${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 8 completion
echo -e "${YELLOW}[3/5] Checking Wave 8 prerequisites...${NC}"
if [ -f "$PROJECT_DIR/.agent-done-wave8" ]; then
    echo -e "${GREEN}  ✓ Wave 8 completed${NC}"
else
    echo -e "${YELLOW}  ⚠ Wave 8 marker not found — proceeding anyway${NC}"
fi
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#e0af68,bold] Wave 9: AR Aging & Multi-Currency "
