#!/bin/bash
# ============================================================
# GoldLedger — Wave 3: Multi-User Cognee & Custom DataPoints
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave3.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave3"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 3 Agent Team Launcher${NC}"
echo -e "${CYAN}  Multi-User Cognee & Custom DataPoints${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 2 completion
echo -e "${YELLOW}[3/5] Checking Wave 2 prerequisites...${NC}"
if [ -f "$PROJECT_DIR/.agent-done-wave2" ]; then
    echo -e "${GREEN}  ✓ Wave 2 completed${NC}"
else
    echo -e "${YELLOW}  ⚠ Wave 2 marker not found — proceeding anyway${NC}"
fi
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 3: Multi-User Cognee "
