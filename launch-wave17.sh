#!/bin/bash
# ============================================================
# GoldLedger — Wave 17: Temporal Queries & Cross-Module Intelligence
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave17.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave17"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 17 Agent Team Launcher${NC}"
echo -e "${CYAN}  Temporal Queries & Cross-Module Intelligence${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: Verify Wave 16 completion
echo -e "${YELLOW}[3/5] Checking Wave 16 prerequisites...${NC}"
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 17: Temporal & Cross-Module Intel "
