 ...
 */
export function validateABN(abn: string): { isValid: boolean; error?: string; formattedABN?: string } {
...
export const ENTITY_TYPES = {
    individual: {
        code: 'individual',
        label: 'Individual',
        description: 'A natural person operating as a sole trader without a separate business structure'
    },
    sole_trader: {
        code: 'sole_trader',
        label: 'Sole Trader',
        description: 'An individual running a business under their own name or a registered business name'
    },
    partnership: {
        code: 'partnership',
        label: 'Partnership',
