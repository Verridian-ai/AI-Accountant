/**
 * Market Intelligence Agent tool definitions — Anthropic tool schemas.
 *
 * Extracted from market-intelligence-agent.ts to comply with the 300-line enterprise standard.
 */
...
export const MARKET_INTEL_TOOL_DEFINITIONS: Anthropic.Tool[] = [
  {
