/**
 * Financial Planner tool definitions — Anthropic tool schemas.
 *
 * Extracted from financial-planner.ts to comply with the 300-line enterprise standard.
 */

import Anthropic from '@anthropic-ai/sdk';

export const FINANCIAL_PLANNER_TOOL_DEFINITIONS: Anthropic.Tool[] = [
  {
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        currentSpendingByCategory: { type: 'object', additionalProperties: { type: 'number' } },
        riskProfile: { type: 'string', enum: ['conservative', 'balanced', 'growth', 'aggressive'] },
      },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        patternType: { type: 'string', description: 'Optional pattern type filter' },
      },
      required: ['query'],
    },
  },
  ...
  },
  {
    ...
    description: 'Gather comprehensive planning context from all relevant modules.',
    input_schema: {
      type: 'object' as const,
      properties: { query: { type: 'string', description: 'Planning context query' } },
      required: ['query'],
    },
  },
  {
