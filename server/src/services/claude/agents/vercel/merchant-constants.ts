/**
 * Merchant Intelligence constants — known merchant patterns and regex patterns.
 *
 * Shared between legacy and Vercel merchant intelligence agents.
...
export const MERCHANT_SYSTEM_PROMPT = `You are an Australian merchant intelligence specialist. Your job is to resolve abbreviated bank statement merchant descriptions into canonical business names, determine their GST registration status, and infer appropriate transaction categories.
