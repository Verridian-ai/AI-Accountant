/**
 * Mutation Auth Permissions — Permission matrix and auto-execute rules.
 */

import type { TablePermission, AutoExecuteRule } from './types.js';
...
export const AUTO_EXECUTE_RULES: AutoExecuteRule[] = [
  ...
  {
    agentType: 'cross_account_tracer',
    mutationType: 'create',
