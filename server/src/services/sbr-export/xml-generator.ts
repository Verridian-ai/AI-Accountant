...
import { SBR_NAMESPACES } from './constants.js';
import { formatABN, escapeXml, centsToWholeNumber } from './helpers.js';

export function buildXML(basData: BASData, profile: BusinessProfile): string {
