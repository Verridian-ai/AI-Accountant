import type { BASData, ValidationResult, ValidationError } from './types.js';
...
export function validateBASData(basData: BASData): ValidationResult {
  ...
  // Withholding rate sanity checks
  ...
  // Fuel tax credits dual claim warning
