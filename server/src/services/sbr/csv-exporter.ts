 ...
 * SBR CSV Exporter
 *
 * Generates CSV summary of BAS data for record keeping.
 */
...
/**
 * Generate CSV summary of BAS data
 */
export function generateCSVSummary(basData: BASData, profile: BusinessProfile): string {
  const rows: string[][] = [];
