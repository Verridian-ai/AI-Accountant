#!/bin/bash
# ============================================================
# GoldLedger — Wave 1: Chat→Agent Bridge & Intent Routing
# ============================================================
# Spawns Claude Code with Agent Teams in a tmux session.
# Run from WSL: bash launch-wave1.sh
# ============================================================
...
TMUX_SESSION="goldledger-wave1"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

echo -e "${CYAN}============================================================${NC}"
echo -e "${CYAN}  GoldLedger — Wave 1 Agent Team Launcher${NC}"
echo -e "${CYAN}  Chat→Agent Bridge & Intent Routing${NC}"
echo -e "${CYAN}============================================================${NC}"
echo ""
...
# Step 3: No prerequisite wave — Wave 1 is foundational
echo -e "${YELLOW}[3/5] Checking prerequisites...${NC}"
echo -e "${GREEN}  ✓ Wave 1 is foundational — no prior wave required${NC}"
...
tmux set-option -t "$TMUX_SESSION" -g status-left "#[fg=#f7768e,bold] Wave 1: Chat→Agent Bridge "
